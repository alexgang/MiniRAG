...
from minirag.llm import gpt_4o_mini_complete, hf_model_complete, hf_embedding,openai_embedding,ollama_model_complete, ollama_embed
...
def get_args(): 
    ...
    parser.add_argument('--outputpath', type=str, default='./logs/Default_output-ds1.5b.csv')
    ...
    with open(output_path, mode='a', newline='', encoding='utf-8') as log_file:
        ...
        for QUESTIONid in trange(row_count,len(QUESTION_LIST)):#
            ...
            try:
                ...
                print('minirag_Answer', minirag_answer)
